# This repository contains the data and codes used to generate the figures and results in the manuscript: 'El Nino amplified food security in Early Modern Europe'
