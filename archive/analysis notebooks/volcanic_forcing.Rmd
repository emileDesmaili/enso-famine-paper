...
# ── Colour palette (Okabe–Ito inspired, colour-blind friendly) ───────────────
COL_ENSO  <- "#0072B2"          # blue          – ENSO series
COL_GVF   <- "#D55E00"          # vermilion     – GVF series
COL_GR    <- "#009E73"          # bluish green  – Greenland sulfate
COL_ANT   <- "#E69F00"          # amber-orange  – Antarctica sulfate
COL_BASE  <- "#0072B2"          # blue          – baseline price IRF
COL_VOLC  <- "#D55E00"          # vermilion     – V.F.-controlled IRF
